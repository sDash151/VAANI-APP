    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildProgressItem(context, 'Elementary', 0.75),
          const SizedBox(height: 12),
          _buildProgressItem(context, 'Intermediate', 0.30),
          const SizedBox(height: 12),
          _buildProgressItem(context, 'Conversation', 0.45),
          const SizedBox(height: 12),
          _buildProgressItem(context, 'Morals', 0.60),
          const SizedBox(height: 12),
          _buildProgressItem(context, 'Advanced', 0.80),
          const SizedBox(height: 8),
          Align(
